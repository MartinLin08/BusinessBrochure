...
public class DTMActivity extends AppCompatActivity {
    ...
    private void InitFunction() {
        ...
        last_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent next_intent = new Intent(DTMActivity.this, F1Activity.class);
        ...
        next_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent next_intent = new Intent(DTMActivity.this, SkiActivity.class);
                startActivity(next_intent);
            }
        });
        ...
        home_fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent bwt_intent = new Intent(DTMActivity.this, HomepageActivity.class);
        ...
        bwt_fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent bwt_intent = new Intent(DTMActivity.this, CutscenesActivity.class);
                startActivity(bwt_intent);
            }
        });
    }
    ...
    private void addImageView (){
        ...
        sport1_imv = new ImageView(DTMActivity.this);
        sport1_imv.setBackgroundResource(R.drawable.dtm_1);
        ...
        new Handler().postDelayed(new Runnable() {
            public void run() {
                sport2_imv = new ImageView(DTMActivity.this);
                sport2_imv.setBackgroundResource(R.drawable.dtm_2);
                RelativeLayout.LayoutParams sport_pm = new RelativeLayout.LayoutParams(WIDTH, HEIGHT);
                sport2_imv.setLayoutParams(sport_pm);
                sport_rlt.addView(sport2_imv);
                Animation am_sport = AnimationUtils.loadAnimation(DTMActivity.this, R.anim.translate);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(DTMActivity.this, VideoActivity.class);
