...
public class F1Activity extends AppCompatActivity {
    ...
    private void InitFunction() {
        ...
        last_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent next_intent = new Intent(F1Activity.this, SportsSponsorshipActivity.class);
        ...
        next_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent next_intent = new Intent(F1Activity.this, DTMActivity.class);
                startActivity(next_intent);
            }
        });
        ...
        home_fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent bwt_intent = new Intent(F1Activity.this, HomepageActivity.class);
        ...
        bwt_fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent bwt_intent = new Intent(F1Activity.this, CutscenesActivity.class);
                startActivity(bwt_intent);
            }
        });
    }
    ...
    private void addImageView (){
        ...
        sport1_imv = new ImageView(F1Activity.this);
        sport1_imv.setBackgroundResource(R.drawable.f1_1);
        ...
        new Handler().postDelayed(new Runnable() {
            public void run() {
                sport2_imv = new ImageView(F1Activity.this);
                sport2_imv.setBackgroundResource(R.drawable.f1_2);
                RelativeLayout.LayoutParams sport_pm = new RelativeLayout.LayoutParams(WIDTH, HEIGHT);
                sport2_imv.setLayoutParams(sport_pm);
                sport_rlt.addView(sport2_imv);
                Animation am_sport = AnimationUtils.loadAnimation(F1Activity.this, R.anim.translate);
    ...
    private void ItemAnimation() {
        ...
        sport1_imv.startAnimation(am_sport);
    }

    @Override
    public void onBackPressed() {
        Intent intent = new Intent(F1Activity.this, VideoActivity.class);
